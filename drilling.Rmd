...
seqtab %>%
  ...
  theme_tidy() + guides(fill = guide_legend(reverse = T)) +
  theme(
...
t <- kegg %>%
  mutate(reference = case_when(
    ...
    module == "M00127" ~ "Thiamine biosynthesis (DXP/tyrosine)",
    module == "M00895" ~ "Thiamine biosynthesis (DXP/glycine)",
...
```{r}
library(patchwork)
p1 / p2 / p3 / p4 & theme(plot.margin = margin())
```

```{r}
ggsave("heatmap.pdf", width = 20, height = 30, units = "cm")
```
